...
def input():
    if request.method == 'POST':
        ...
        print(acres,cost,"cccccvvcvv")
        if acres>=1 and cost>=50000:
            ...
            return render_template("input.html", details= "Enter valid details")
...
def input1():
    if request.method == 'POST':
        ...
        if acres>=1 and cost>=50000:
            ...
            return render_template("input1.html", details= "Enter valid details")
